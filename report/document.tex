...
\bibitem{rssa} M. Klinkowski, G. Zalewski, K. Walkowiak ``Optimization of Spectrally and Spatially Flexible Optical Networks with Spatial Mode Conversion'', access via the Internet \textit{https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=\&arnumber=8396122}
